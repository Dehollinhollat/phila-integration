...
describe('peutAccederContact', () => {
  ...
  it('referent_integration peut acceder a tous les contacts de son campus (pas seulement les siens — il peut aider un collegue)', async () => {
...
describe('filtreContactsParRole', () => {
  ...
  it('referent_integration filtre par campus (voit tout le campus, pas que ses contacts)', () => {
